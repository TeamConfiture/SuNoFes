...
define madame = Character(_('Madame Arc-En-Ciel'), who_color="#ffffff")
define grosso = Character(_('Grosso'), who_color="#ffffff")
define maigrichon = Character(_('Maigrichon'), who_color="#ffffff")
define noir = Character(_('Père Noir'), who_color="#ffffff")
define violet = Character(_('Violet'), who_color="#720068")
define indigo = Character(_('Indigo'), who_color="#ffffff")
define grosso_maigrichon = Character(_('Grosso & Maigrichon'), who_color="#ffffff")
