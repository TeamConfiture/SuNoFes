label chap4:
    ...
    with dissolve
    play voice renpy.random.choice(audio.Emeraude_Speak)
    ...
    show blanche neutral close at left
    play voice renpy.random.choice(audio.Emeraude_No)
    ...
    play voice renpy.random.choice(audio.Emeraude_Exclamation)
...
label chap4_2:
    ...
    show blanche neutral close at left
    with dissolve
    play voice renpy.random.choice(audio.Emeraude_Happy)
