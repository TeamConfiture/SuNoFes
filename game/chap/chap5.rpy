label chap5:
    ...
    play voice renpy.random.choice(audio.Piou_Speak)
    ...
    play voice renpy.random.choice(audio.Jaune_Sleepy)
    ...
    play voice renpy.random.choice(audio.Blanche_Exclamation)
    ...
    menu:
        "Lui lancer un regard méprisant":
            ...
            play voice renpy.random.choice(audio.Blanche_Angry)
            ...
            play voice renpy.random.choice(audio.Piou_Angry)
    ...
    show blanche neutral open at left
    play voice renpy.random.choice(audio.Blanche_Laugh)
    ...
    hide blanche surprised close at left
    hide jaune at right
    with dissolve
...
label chap5_2:
    ...
    play voice renpy.random.choice(audio.Piou_Cry)
    ...
    hide jaune at right with dissolve
    ...
    show jaune at right
    with dissolve
    play voice renpy.random.choice(audio.Grosso_Sigh)
    ...
    play voice renpy.random.choice(audio.Jaune_Sleepy)
    jaune "..."
    play voice renpy.random.choice(audio.Jaune_Angry)
