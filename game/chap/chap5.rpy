label chap5:
    ...
    play sound renpy.random.choice(sound.Jaune_Sleepy)
...
label chap5_2:
    ...
    play sound renpy.random.choice(sound.Piou_Cry)
    ...
    show jaune at right
    with dissolve
    play sound renpy.random.choice(sound.Grosso_Sigh)
    ...
    play sound renpy.random.choice(sound.Jaune_Sleepy)
    jaune "..."
    play sound renpy.random.choice(sound.Jaune_Angry)
