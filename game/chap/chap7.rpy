...
label chap7:
    ...
    play sound renpy.random.choice(sound.Red_Angry)
    ...
    play sound renpy.random.choice(sound.Red_Speak)
...
label chap7_2:
    ...
    menu:
        "L'assommer et prendre sa boule":
            ...
            show blanche neutral close at left
            play sound renpy.random.choice(sound.Red_Happy)
    ...
    if good > neutral and good > bad: 
        ...
        play sound renpy.random.choice(sound.Maigrichon_Angry)
        maigrichon "Dans cette direction ! J'ai vu l'enfant partir par là !" with vpunch
        play sound renpy.random.choice(sound.Grosso_No)
        grosso "Non, je l'ai vu partir par ici !"
        grosso_maigrichon "..."
        play audio renpy.random.choice(sound.Maigrichon_Sigh)
        play audio renpy.random.choice(sound.Grosso_Sigh)
