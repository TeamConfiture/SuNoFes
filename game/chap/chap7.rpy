...
label chap7:
    ...
    play voice renpy.random.choice(audio.Red_Angry)
    ...
    play voice renpy.random.choice(audio.Red_Speak)
...
label chap7_2:
    ...
    menu:
        "L'assommer et prendre sa boule":
            ...
            show blanche neutral close at left
            play voice renpy.random.choice(audio.Red_Happy)
    ...
    if good > neutral and good > bad: 
        ...
        grosso_maigrichon "..."
        play voice renpy.random.choice(audio.Maigrichon_Sigh)
