...
label lake_fishing_axolotl:
    ...
    play sound renpy.random.choice(sound.Axo_Partial_Happy)
    axolotl "Pica !"
    cyan "Tu m'as manqué petit farceur, reste me tenir compagnie veux-tu ?"
    play sound renpy.random.choice(sound.Axo_Full_Happy)
    axolotl "Picaruuuu."
    call screen chap3_lake_phishing
...
label lake_fishing_axolotl_revealed:
    ...
    if lake_phishing_talked_axolotl == 1:
        play sound renpy.random.choice(sound.Axo_Full_Question)
        axolotl "Picaru ?"
    elif lake_phishing_talked_axolotl == 2:
        play sound renpy.random.choice(sound.Axo_Full_Angry)
        axolotl "Picaru !"
    elif lake_phishing_talked_axolotl == 3:
        play sound renpy.random.choice(sound.Axo_Full_Attack)
