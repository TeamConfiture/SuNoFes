label chap1:
    ...
    play voice renpy.random.choice(audio.Violet_Angry_Short)
    ...
    show blanche cry close at left
    play voice renpy.random.choice(audio.Violet_Angry)
    ...
    play voice renpy.random.choice(audio.Violet_Speak)
    ...
    play voice renpy.random.choice(audio.Violet_Patronizing)
    ...
    show blanche cry open at left
    play voice renpy.random.choice(audio.Blanche_Sigh)
    ...
    show blanche surprised close at left
    play voice renpy.random.choice(audio.Violet_Happy)
...
label onclick_mulberry_background:
    ...
    show blanche pout close at left
    play voice renpy.random.choice(audio.Blanche_No)
    blanche "Pas encore…"
    hide blanche
    hide violet
    call screen  chap1_mulberry_search("chap1_2", "onclick_mulberry_background")
...
label chap1_2:
    ...
    play voice renpy.random.choice(audio.Maigrichon_Angry)
