label chap2:
    ...
    play voice renpy.random.choice(audio.Indigo_Speak)
    ...
    play voice renpy.random.choice(audio.Indigo_Angry)
    ...
    play voice renpy.random.choice(audio.Indigo_Happy)
...
label chap2_completed:
    ...
    play voice renpy.random.choice(audio.Grosso_Question)
