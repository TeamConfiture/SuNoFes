label chap2:
    ...
    indigo "Aaaah... Ces étoiles sont si belles ! Un voyageur m'a autrefois dit que ces ensembles de points lumineux avaient des noms dans la langue de Molière."
    indigo "Si seulement je pouvais les connaître... Je serais alors en mesure de décrire le ciel que je vois et pouvoir transmettre ces formidables connaissances aux futurs voyageurs qui s'arrêteront près de mon lac !"
    ...
    menu:
        "Le prendre de haut":
            ...
            indigo "Ce n'est pas l'impression que tu me donnais quand tu courais il y a 5 min..."
        ...
        "Se confondre platement en excuses":
            ...
            indigo "Ce lieu est un endroit incontournable pour son lac. Tous les voyageurs qui me rendent visite sont là pour admirer cette sublime vue. Il est donc proscrit de prendre quoi que ce soit de ce paysage."
    ...
    show blanche cry open at left
    blanche "Il me faut absolument cette boule. Il en va de la vie de mon père malade ! Je veux lui montrer à quoi ressemble les couleurs de l'Arc-en-Ciel !"
    show blanche cry close at left
    indigo "Bien qu'elle ne me soit d'aucune utilité et que ton intention soit louable, je ne peux faire d'écart à la promesse que j'ai contractée auprès de Madame Arc-En-Ciel le jour où elle m'a confié ce poste de gardiennage."
    show blanche cry open at left
    blanche "Vous ne pourriez pas faire une toute petite exception pour moi ?"
    show blanche cry close at left
    indigo "Je ne fais des exceptions qu'aux personnes qui m'ont prouvé leur valeur intellectuelle. Pas à n'importe qui. Si tu veux cette boule, il va te falloir prouver ta valeur !"
    show blanche surprised open at left
    ...
    show blanche neutral close at left
    indigo "Sûrement. Tout ce que je sais, c'est qu'un voyageur m'a une fois donné les noms de toutes ces jolies choses. Malheureusement, je n'ai pas pu associer ces appellations avec ces étoiles."
    ...
    madame "Quoi ?! On me vole mes 7 boules de cristal et vous ne faites rien ??! Vous êtes une bande d'incapables ! Vous, comme les autres chats gardiens, je vous ai confié une mission et vous n'êtes même pas capables de la tenir !"
