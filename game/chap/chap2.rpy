label chap2:
    ...
    play sound renpy.random.choice(sound.Indigo_Speak)
    ...
    play sound renpy.random.choice(sound.Indigo_Angry)
    ...
    play sound renpy.random.choice(sound.Indigo_Happy)
...
label chap2_completed:
    ...
    play sound renpy.random.choice(sound.Grosso_Question)
    ...
    play sound renpy.random.choice(sound.Maigrichon_Sigh)
