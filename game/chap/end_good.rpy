label end_good:
    ...
    play voice renpy.random.choice(audio.ArcEnCiel_Hey)
    ...
    play voice renpy.random.choice(audio.ArcEnCiel_Question)
    ...
    show blanche cry open at left
    play voice renpy.random.choice(audio.Blanche_Moan)
    blanche "Laissez-moi juste les montrer à mon papa !"
    show blanche cry close at left
    show mme neutralf open at right
    play voice renpy.random.choice(audio.ArcEnCiel_Sigh)
    ...
    play voice renpy.random.choice(audio.ArcEnCiel_Angry)
    ...
    play voice renpy.random.choice(audio.Noir_Gasp)
    noir "Urgh… Urgh…"
    show noir bandeau hurt close at right
    "Noir gémit."
    ...
    play voice renpy.random.choice(audio.ArcEnCiel_No)
    madame "Repose-toi… Garde tes forces."
    show mme ignore close at farLeft
    show noir bandeau sigh open at right
    play voice renpy.random.choice(audio.Noir_Speak)
    ...
    play voice renpy.random.choice(audio.Noir_Yes)
    ...
    play voice renpy.random.choice(audio.Noir_Exclamation)
    noir "Huh ? Ciel ? Que fais-tu ?" with vpunch
    show noir bandeau surprised close at right
    show mme angry open at left
    play voice renpy.random.choice(audio.ArcEnCiel_Exasperate)
    ...
    "Noir sourit."
    show mme blush open at left
    play voice renpy.random.choice(audio.ArcEnCiel_Yes)
    madame "Et moi aussi…"
    show mme blush close at left
