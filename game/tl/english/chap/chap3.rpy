...
translate english chap3_57fec416:
    ...
    blanche "The animator Cyan is very well known to the audience for his show Jean Racine and Willows."
...
translate english chap3_5ea786c4:
    ...
    blanche "According to Daddy, he and his brother go through the forests of the world to present the beauty of nature to the other cats."
...
translate english chap3_3b46c6b2:
    ...
    cyan "Welcome to Jean Racine and Willows, the most renowned Art and Culture broadcast of World 2! "
...
translate english chap3_2d44a6ea:
    ...
    cyan "Admire these magnificent hundred-year-old oaks, these majestic beeches and these little firs."
...
translate english chap3_9ee4f5d2:
    ...
    cyan "These are all the results of collaboration between humans and nature."
...
translate english chap3_8699d679:
    ...
    cyan "To show the Rainbow Forest without its trouts, is like to cook a crepe recipe live without eggs."
...
translate english chap3_1c9ad485:
    ...
    blanche "Don't underestimate children! We can do a lot of things!"
...
translate english chap3_454b7ee6:
    ...
    blanche "It's just that... It's a bit complicated, you probably wouldn't understand me."
...
translate english chap3_e5dd8db0:
    ...
    blanche "I'm looking for the Cyan ball."
...
translate english chap3_424eed34:
    ...
    cyan "We are not supposed to part with it. It is part of our contract and the Cyanmese duo cannot fail!"
...
translate english chap3_e75e21a4:
    ...
    blanche "He told me that he would like to see the colors of the rainbow one last time."
...
translate english chap3_aa5a25bb:
    ...
    blanche "At home, everything is black and white. There aren't many colors."
...
translate english chap3_7d9e022a:
    ...
    blanche "Maybe that's why I never knew about his fame."
...
translate english chap3_33de6278:
    ...
    cyan "Noir was a great fisherman. I had done one of my very first reports on the Dark Quidor river, a very dark river that absorbs all the misfortunes of the world."
...
translate english chap3_e79959d1:
    ...
    cyan "At that time, your father hoped to catch the golden pike, a local legend."
...
translate english chap3_e9d312f8:
    ...
    cyan "Unfortunately, misfortune came to your dad. His love of fishing blinded him forever."
...
translate english chap3_78c6b0d2:
    ...
    cyan "I remember that all the newspapers at the time wrote about it, it was a real tragedy."
...
translate english chap3_aff62ef9:
    ...
    blanche "For a while now, his condition has been worsening. I hope I'll have time to show him the seven colors of the rainbow."

# game/chap/chap3.rpy:114
translate english chap3_c50050fd:

    # cyan "Bon, dans ce cas, c'est d'accord."
    cyan "Well, in that case, it's okay."
...
translate english chap3_2a2ba8f9:
    ...
    cyan "We don't have much of a choice, otherwise the report is ruined. So if it makes Noir happy, I'm willing to make this gesture."
...
translate english chap3_b5b28b3f:
    ...
    cyan "See that lake where the river starts? That's where a lot of rainbow trouts used to be."
...
translate english chap3_3ccb7a85:
    ...
    cyan "I provide you with the fishing rod and wish you good luck."
...
translate english chap3_2_ce9c4c50:
    ...
    cyan "I didn't expect to bring such a rare gem on my show!"
...
translate english chap3_2_d2cd7ff2:
    ...
    cyan "An exceptional fan of the show gave us this Rainbow trout freshly caught in the river."
...
translate english chap3_2_03519786:
    ...
    maigrichon "Don't argue. We have a few words to say to both of you."
...
translate english chap3_2_7cfb8e01:
    ...
    cyan "I won't even bother to explain, you wouldn't understand."
...
translate english chap3_2_ddc0005b:
    ...
    cyan "I also know what I am risking and I am fully aware of it."

# game/chap/chap3.rpy:165
translate english chap3_2_6eae29e2:

    # grosso "Pfff... Pathétique."
    grosso "Pfff... Pathetic."
...
translate english chap3_2_2761b796:
    ...
    grosso "At least tell us where this child has gone, it will make it easier for us and perhaps ease your sentence."
...
translate english strings:
    ...
    new "Calling him a bad guy"

    # game/chap/chap3.rpy:44
    old "Partir chercher la boule ailleurs"
    new "Looking for the ball elsewhere"
